#ifndef CRAZYFLIE_RETURN_H
#define CRAZYFLIE_RETURN_H
/*
 ...
 */
class CCrazyflieReturnToBase : public CCI_Controller {
    public:
    /* Class constructor. */
    CCrazyflieReturnToBase();
    /* Class destructor. */
    virtual ~CCrazyflieReturnToBase() {}
